...
bool GameScene::OnCreate()
{
	...
	HumberEngine::GetInstance()->SetCamera(new Camera());
	HumberEngine::GetInstance()->GetCamera()->SetPosition(glm::vec3(0.0f, 0.0f, 4.0f));
...
void GameScene::Render()
{
	...
	shape->Render(HumberEngine::GetInstance()->GetCamera());
}
