...
public:
	...
	void CreateProgram(const std::string& shaderName_, const std::string& vertexShaderFileName_, const std::string& fragmentShaderName_);
...
private:
	...
	static std::string ReadShader(const std::string& filePath_);
